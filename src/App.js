...
function App() {
  const title = 'Travel to place of your dreams NOW';
  const text = 'Book flights and travel to the most exotic places in the world for a great price, alogn with getting great reservations at top quality hotels and resorts';
  const urlArray = [
    ...
    'https://images.unsplash.com/photo-1610641818989-c2051b5e2cfd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80',
